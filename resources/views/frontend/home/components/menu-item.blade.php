<section class="fp__menu mt_95 xs_mt_65">
    <div class="container">
        ...
        <div class="row grid">
            ...
            <div class="col-xl-3 col-sm-6 col-lg-4  chicken dresserts wow fadeInUp"
                 data-wow-duration="1s">
                <div class="fp__menu_item">
                    <div class="fp__menu_item_img">
            ...
            <div class="col-xl-3 col-sm-6 col-lg-4  chicken dresserts wow fadeInUp"
                ...
                <div class="fp__menu_item">
                    ...
                    <div class="fp__menu_item_text">
                        ...
                        <a class="title"
                           href="menu_details.html">daria shevtsova</a>
            ...
            <div class="col-xl-3 col-sm-6 col-lg-4  chicken dresserts wow fadeInUp"
                ...
                <div class="fp__menu_item">
                    <div class="fp__menu_item_img">
                        <img src="images/menu2_img_7.jpg"
                             alt="menu"
                             class="img-fluid w-100">
                        <a class="category"
                           href="#">grill</a>
            ...
            <div class="col-xl-3 col-sm-6 col-lg-4  burger pizza wow fadeInUp"
                ...
                <div class="fp__menu_item">
                    <div class="fp__menu_item_img">
                        <img src="images/menu2_img_8.jpg"
                             alt="menu"
                             class="img-fluid w-100">
                        <a class="category"
                           href="#">chicken</a>

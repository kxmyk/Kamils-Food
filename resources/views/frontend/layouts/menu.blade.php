    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="menu_icon d-flex flex-wrap">
                <li>
                    <a href="#"
                       class="menu_search"><i class="far fa-search"></i></a>
    ...
    <div class="fp__menu_cart_boody">
        ...
        <ul>
            ...
            <li>
                ...
                <div class="menu_cart_text">
                    <a class="title"
                       href="#">Competently Supply Customized Initiatives</a>
        ...
        <a class="cart_view"
           href="cart_view.html"> view cart</a>
        <a class="checkout"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5"
                        id="staticBackdropLabel">Book a Table</h1>
                    <button type="button"
                            class="btn-close"
                ...
                <div class="modal-body">
                    <form class="fp__reservation_form">
                        ...
                        <input class="reservation_input"
                               type="date">
                        <select class="reservation_input"
                                id="select_js">
